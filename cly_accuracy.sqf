...
_inarray=(_weapontype==2 and _dispersion>CLY_mindispersion) or _weapon in CLY_accuracyarray;
_grenade=_magtype==16 and _magcount==1;

if (local _unit and _inarray and !_grenade and _bulletexplosive!=1) then {
	_elevation=0.002;
